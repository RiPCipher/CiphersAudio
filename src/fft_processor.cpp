...
public:
	...
	// Core FFT operations (using PackedFloat32Array)
	...
	// Core FFT operations (using FFTBuffer for better performance)
	...
	// Helper to get the required output size
